...
use App\Repository\Admin\UserContactRepository;
...
class UserContact
{
    ...
    #[ORM\OneToOne(inversedBy: 'userUserContact')]
    ...
    public function setTitleBefore(?string $titleBefore): static
    {
    ...
    public function setTitleAfter(?string $titleAfter): static
    {
