...
final class HowItWorksController extends AbstractController
{
    ...
    #[Route('/{_locale<%app.supported_locales%>}/jak-to-funguje', name: 'app_web_how_it_works')]
    public function index(Request $request): Response
    {
        $article = $this->entityManager->getRepository(Article::class)->findOneBy([
            'urlAlias' => 'jak-to-funguje',
            'publication' => 1
        ]);
        ...
        return $this->render('web/how_it_works/' . $request->getLocale() . '/index.html.twig', [
