...
final class RemovalsController extends AbstractController
{
    ...
    #[Route('/{_locale<%app.supported_locales%>}/stehovani', name: 'app_web_removals')]
    public function index(Request $request): Response
    {
        ...
        return $this->render('web/removals/' . $request->getLocale() . '/index.html.twig', [
