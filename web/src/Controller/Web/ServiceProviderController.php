...
final class ServiceProviderController extends AbstractController
{
    ...
    #[Route('/{_locale<%app.supported_locales%>}/jste-dopravce', name: 'app_web_service_provider', methods: ['GET'])]
    public function index(Request $request): Response
    {
        $article = $this->entityManager->getRepository(Article::class)->findOneBy([
            'urlAlias' => 'jste-dopravce',
            'publication' => 1
        ]);
        ...
        return $this->render('web/service_provider/' . $request->getLocale() . '/index.html.twig', [
